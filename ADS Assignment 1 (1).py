...
export_data = pd.read_excel(
    r'C:\Users\Diraj\Downloads\Masters - DS\Applied DS- 1\exports_good_service(annual%growth).xlsx')
...
batsman = pd.read_csv(
    'C:/Users/Diraj/Downloads/Masters - DS/Applied DS- 1/topbatsman.csv')
